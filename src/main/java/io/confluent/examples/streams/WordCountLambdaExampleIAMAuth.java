...
public class WordCountLambdaExampleIAMAuth {

    static final Logger logger = LogManager.getLogger(WordCountLambdaExampleIAMAuth.class);
    ...
    public static void main(final String[] args) {
        ...
        final Properties saslConfiguration = getSaslConfiguration();

        final Properties streamsConfiguration = getStreamsConfiguration(bootstrapServers, saslConfiguration);
    ...
    /**
     * Configure the Streams application for AWS IAM.
     * <p>
     * Load various AWS IAM setting for Amazon MSK from properties file.
     *
     * @return Properties getSaslConfiguration
     */
    private static Properties getSaslConfiguration() {

        final Properties saslConfiguration = new Properties();

        //load a properties file
        try (InputStream input = WordCountLambdaExampleIAMAuth.class.getClassLoader().getResourceAsStream("config.properties")) {

            //load a properties file from class path, inside static method
            saslConfiguration.load(input);

            logger.debug(saslConfiguration);
     ...
     */
    private static Properties getStreamsConfiguration(final String bootstrapServers, final Properties saslConfiguration) {
